...
const CatCard = (props: any) => {
    ...
    return (
        ...
        <div className="relative overflow-hidden w-full h-36 flex justify-center items-center rounded-lg transform transition-transform duration-300 ease-in-out hover:scale-110 cursor-pointer border-[2px] border-transparent hover:border-[#353843]">

...
const Profile = (props: any) => {
    ...
    return (
        <div className="w-full h-auto p-20 flex justify-center items-center flex-col bg-[#121317]">
            <div id='subContainer' className='flex justify-start flex-col mt-20'>
                ...
                <div id='subCard' className="w-[614px] h-auto rounded-xl overflow-hidden border border-[#2f3033] mt-6">
                    ...
                    <div className="w-full h-auto flex justify-between items-center p-8">
                        <div className="flex flex-col">
                            <h1 className="text-white text-base font-semibold">Wsigma+</h1>
